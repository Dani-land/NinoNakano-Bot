...
export default {
  ...
  run: async ({client, m, args}) => {
    ...
    if (!mime) {
      return client.reply(
        m.chat,
        `✐ Responde a un audio o canción usando *${prefa}rvocal*.`,
        m
      )
    }

    m.reply('⏳ Separando voces y música, espera un momento...')
    ...
    try {
      ...
      if (!vocal || !instrumental) {
        return m.reply('✘ No pude separar el audio correctamente.')
      }
      ...
      m.reply('✓ Audio separado correctamente.')
